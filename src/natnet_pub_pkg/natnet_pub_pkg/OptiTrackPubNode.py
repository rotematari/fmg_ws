...
class OptiTrackPubNode(Node):
    ...
    def publish_pose(self):
        ...
        shoulder = sample['shoulder'][0]
        elbow = sample['elbow'][0]
        # self.get_logger().info(f'Sample data: shoulder  {shoulder} elbow {elbow}')
    ...
    def calculate_quaternion(self,point_1, point_2):
        ...
        vector = np.array(point_2) - np.array(point_1) + 0.00000001
        position = vector/2
